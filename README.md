...
ВНИМАНИЕ: Система спроектирована разработчиком, рисунки и описание(readme, docstring) делал ИИ для ускорения работы.
Визуальная схема:
...
## 13. ВНИМАНИЕ
Система спроектирована разработчиком, рисунки и описание(readme, docstring) делал ИИ для ускорения работы.